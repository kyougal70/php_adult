        ...
        var data = {
            "resource": {
                ...
                "tags": [{
                    ...
                    "vtp_uniqueTriggerId": "95519355_8",
                    "tag_id": 19
                }, {
                    "function": "__cl",
                    "tag_id": 20
                    ...
                    "metadata": ["map"],
                    "once_per_event": true,
                    "vtp_html": "\u003Cscript\u003Efunction appendHints(e){function g(b){var a=document.createElement(\"img\");a.setAttribute(\"width\",\"1\");a.setAttribute(\"height\",\"1\");a.setAttribute(\"border\",\"none\");a.setAttribute(\"src\",b);document.body.appendChild(a)}return navigator\u0026\u0026navigator.userAgentData\u0026\u0026navigator.userAgentData.getHighEntropyValues?navigator.userAgentData.getHighEntropyValues(\"architecture bitness fullVersionList platformVersion model wow64\".split(\" \")).then(function(b){var a={};\"architecture bitness fullVersionList platform platformVersion model mobile wow64\".split(\" \").forEach(function(c){b\u0026\u0026\nnull!==b[c]\u0026\u0026void 0!==b[c]\u0026\u0026(a[c]=b[c])});var d=btoa(JSON.stringify(a)),f=new URL(e),h=new URLSearchParams(f.search);h.append(\"ch\",d);f.search=h;d=f.toString();return g(d),d}):(g(e),Promise.resolve(e))}appendHints(\"https:\/\/ads.trafficjunky.net\/rt?action\\x3dlist\\x26type\\x3dadd\\x26id\\x3d1\\x26context\\x3dNoRegistration\\x26cookiename\\x3dNoRegistration\\x26age\\x3d99999999\\x26maxcookiecount\\x3d10\");\u003C\/script\u003E",
                    ...
                    "metadata": ["map"],
                    "once_per_event": true,
                    "vtp_html": "\u003Cscript\u003Efunction appendHints(e){function g(b){var a=document.createElement(\"img\");a.setAttribute(\"width\",\"1\");a.setAttribute(\"height\",\"1\");a.setAttribute(\"border\",\"none\");a.setAttribute(\"src\",b);document.body.appendChild(a)}return navigator\u0026\u0026navigator.userAgentData\u0026\u0026navigator.userAgentData.getHighEntropyValues?navigator.userAgentData.getHighEntropyValues(\"architecture bitness fullVersionList platformVersion model wow64\".split(\" \")).then(function(b){var a={};\"architecture bitness fullVersionList platform platformVersion model mobile wow64\".split(\" \").forEach(function(c){b\u0026\u0026\nnull!==b[c]\u0026\u0026void 0!==b[c]\u0026\u0026(a[c]=b[c])});var d=btoa(JSON.stringify(a)),f=new URL(e),h=new URLSearchParams(f.search);h.append(\"ch\",d);f.search=h;d=f.toString();return g(d),d}):(g(e),Promise.resolve(e))}appendHints(\"https:\/\/ads.trafficjunky.net\/rt?action\\x3dlist\\x26type\\x3dadd\\x26id\\x3d1\\x26context\\x3dLastButton\\x26cookiename\\x3dLastButton\\x26age\\x3d99999999\\x26maxcookiecount\\x3d10\");\u003C\/script\u003E",
                    "vtp_supportDocumentWrite": true,
                    "vtp_enableIframeMode": false,
                    "vtp_enableEditJsMacroBehavior": false,
                    "vtp_usePostscribe": true,
            ...
            "security_groups": {
                ...
                "google": ["__cid", "__cl", "__ctv", "__e", "__googtag", "__hid", "__r"
                ]
...
*/
                    var C = this || self
                        ...
                        for (var r; w.length && (r = w.shift()); )
                            w.length || u === void 0 ? q = q[r] && q[r] !== Object.prototype[r] ? q[r] : q[r] = {} : q[r] = u
                    };
                    /*
...
*/
        ...
        ;function Zg(a, b, c) {
            ...
            for (var f = 0; f < a.length(); f++) {
                var g = a.get(f);
                g instanceof La && g.has(b) && g.has(c) && (d.set(g.get(b), g.get(c)),
                    e = !0)
            }
            return e ? d : null
        }
        ...
        dh.entries = function(a) {
            ...
            if (a instanceof Uc || a instanceof Wc || typeof a === "string")
                a = eh(a);
            if (a instanceof La || a instanceof cd)
                return new Uc(a.Eb().map(function(b) {
                    return new Uc(b)
                }));
            return new Uc
        }
        ...
        ;var Hi = {
            En: '101509156~101925629~102067555~102067808~102081485~102198178'
        };
        var Ii = {}
        ...
        Ii.Je = Number("0") || 0;
        Ii.rb = "dataLayer";
        Ii.Hn = "ChAIgJq0uwYQ0fWRq77BxOs2EiQAwRPCzEID+Tp5MhO4AQMcNQrUsVxnH2hRCqbOqtcx5V/iPcsaAqTQ";
        var Ki = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
        ...
        ;var ml;
        try {
            ml = JSON.parse(Ta("eyIwIjoiR0IiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY28udWsiLCI0IjoicmVnaW9uMSIsIjUiOmZhbHNlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
        } catch (a) {
            T(123),
                ll(2),
                ml = {}
        ...
        ;function GA() {
            var a = [["cv", R(124) ? FA() : "24"], ["rv", Ii.zh], ["tc", hf.filter(function(b) {
                return b
            }).length]];
        ...
        var NC = function(a) {
            ...
            if (d) {
                ...
                var p = aB(a, "selectorToTriggerIds", {}), q;
                for (q in p)
        ...
        function PC(a, b) {
            ...
            if (e || d) {
                if (d && eB(g, "commonButtonIds", k, []),
                    e) {
                    var m = lb(String(c.cssSelector));
                    eB(g, "selectorToTriggerIds", function(n) {
        ...
        var DD = function(a, b) {
            ...
            function a(c) {
                ...
                if (d && c.which !== 3 && !(c.j || c.timeStamp && c.timeStamp === b)) {
                    ...
                    var e = c.defaultPrevented || c.returnValue === !1, f = aB("lcl", e ? "nv.mwt" : "mwt", 0), g;
        ...
        function VF() {
            ...
            L(this, "read_container_data"),
                R(47) && UF ? a = UF : (a.set("containerId", 'GTM-N96WLM9'),
                    a.set("version", '24'),
            ...
            function() {
                ...
                (function(b) {
                    ...
                    if (d === "QUERY")
                        ...
                        f = yj(e, d, d == "HOST" ? b[a("vtp_stripWww")] : void 0, d == "PATH" ? b[a("vtp_defaultPages")] : void 0);
                    return f
                })
            }();
        ...
        aL.onHtmlSuccess = BA(!0),
            aL.onHtmlFailure = BA(!1);
        function bL() {
            Ji[lk()] = Ji[lk()] || aL;
            vk();
